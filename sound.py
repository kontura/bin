...
SINK_NAME = 'alsa_output.pci-0000_00_03.0.hdmi-stereo'
METER_RATE = 344
...
class PeakMonitor(object):
    ...
    def __init__(self, sink_name, rate):
        ...
        context = pa_context_new(_mainloop_api, None)
    ...
    def sink_info_cb(self, context, sink_info_p, _, __):
        ...
        if self.value == "init":
            ...
            pa_stream = pa_stream_new(context, p, samplespec, None)
